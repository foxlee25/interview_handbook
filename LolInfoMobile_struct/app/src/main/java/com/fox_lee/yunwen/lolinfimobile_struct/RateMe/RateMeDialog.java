package com.fox_lee.yunwen.lolinfimobile_struct.RateMe;
...
public class RateMeDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        stars.getDrawable(2).setColorFilter(getResources().getColor(R.color.colorYellowStar), PorterDuff.Mode.SRC_ATOP);
